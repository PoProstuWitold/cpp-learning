#include <stdio.h>
#include <stdlib.h>
// WERSJA Z WSKAŹNIKIEM DO FUNKCJI

// program wyświetla max z wartosci wybranej funkcji
// w 10 punktach podanego przedziału
// wyznaczenie max za pomocą funkcji wywołujacej wybraną funkcją
...
int main() {
    ...
    float  M;
    int i;
    float (*PF)(float x,float a, float b, float c);
    ...
    M=wartosci( w_a, w_b, w_c, pocz_przedzial,kon_przedz, PF );
    printf("\nmax=%f\n", M);
