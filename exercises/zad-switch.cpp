...
char get_option(int options[]) {
    ...
    for (;;) {  
        ...
        else if (!(search_for_number(options, userChoice))) {  
...
int main() {
    ...
    } while(search_for_number(options1, option1) && search_for_number(options2, option2) && !(sizeof(a) == sizeof(int)));
